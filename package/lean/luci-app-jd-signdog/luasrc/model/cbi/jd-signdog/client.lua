...
o=s:option(Flag,"jd_enable",translate("启用"))
o.rmempty = false
...
o = s:option(ListValue, "serverurl", translate("推送接口"))
o:value("scu", translate("微信"))
o:value("sct", translate("钉钉"))
o.default = "scu"
o.rmempty = false
...
o:depends("serverurl","scu")

o = s:option(Value, "dingding", translate("钉钉机器人 Webhook"))
o.rmempty = true
o.description = translate("钉钉推送，基于钉钉群机器人服务，请自行登录 https://ding-doc.dingtalk.com/ 创建机器人 (仅在自动签到时推送)")
o:depends("serverurl","sct")
